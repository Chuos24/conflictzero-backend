...
class DigitalSignatureService:
    ...
    def get_cert_info(self) -> dict:
        ...
        return {
            ...
            "not_before": getattr(self._certificate, 'not_valid_before_utc', self._certificate.not_valid_before).isoformat() if self._certificate else None,
            "not_after": getattr(self._certificate, 'not_valid_after_utc', self._certificate.not_valid_after).isoformat() if self._certificate else None,
