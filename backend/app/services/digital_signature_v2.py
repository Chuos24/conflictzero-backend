...
class DigitalSignatureService:
    ...
    def get_cert_info(self) -> dict:
        ...
        return {
            ...
            "not_before": (
                self._certificate.not_valid_before_utc.isoformat()
                if self._certificate and hasattr(self._certificate, 'not_valid_before_utc')
                else self._certificate.not_valid_before.isoformat()
                if self._certificate
                else None
            ),
            "not_after": (
                self._certificate.not_valid_after_utc.isoformat()
                if self._certificate and hasattr(self._certificate, 'not_valid_after_utc')
                else self._certificate.not_valid_after.isoformat()
                if self._certificate
                else None
            ),
